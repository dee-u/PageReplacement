	...
	<div class="wrapper">
        <nav id="sidebar">
			...
			<div class="p-4 pt-5">
				...
				<form id="schedulingForm" style="margin-left: 15px; margin-right: 10px"" novalidate accept-charset="utf-8">
					<div class="form-row">
					...
					<button type="submit" class="btn btn-light">Solve</button>
				</form>           
			</div>
        </nav>
					...
					<div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="content">
									<div class="head">
                                        <h5 class="mb-0">Page Replacement Result</h5>
                                    </div>
